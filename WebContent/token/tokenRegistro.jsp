...
<div class="container">
	...
	<c:if test="${connectiontoken != null}">
		...
		<form
			action="ConnectiontokenServlet?action=actualizar&id=${connectiontoken.id}"
			method="POST">
	</c:if>
	<c:if test="${connectiontoken == null}">
		...
		<div class="card m-5">
			<div class="card-header bg-red">Conexion Token</div>
			<div class="card-body">
				<form>
					<div class="row">
						<div class="col-sm-6">
							<div class="input-group mb-3">
								<span class="input-group-text">Hostname:</span> <input
									type="text" name="host" value="${connectiontoken.host}"
									class="form-control"
									aria-label="Amount (to the nearest dollar)">
							</div>
							<div class="input-group mb-3">
								<span class="input-group-text">Userbd:</span> <input type="text"
									name="userdb" value="${connectiontoken.userdb}"
									class="form-control"
									aria-label="Amount (to the nearest dollar)">
							</div>
							<div class="input-group mb-3">
								<span class="input-group-text">Puerto</span> <input
									type="text" name="port" value="${connectiontoken.port}"
									class="form-control"
									aria-label="Amount (to the nearest dollar)">
							</div>
							
								<div class="input-group mb-3">
								<span class="input-group-text">Db</span> <input
									type="text" name="db" value="${connectiontoken.db}"
									class="form-control"
									aria-label="Amount (to the nearest dollar)">
							</div>
								...
								<span class="input-group-text">State</span> <input
									type="text" name="state" value="${connectiontoken.state}"
									class="form-control"
									aria-label="Amount (to the nearest dollar)">
							</div>
						...
						<div class="col-sm-6">
							...
							<div class="input-group mb-3">
								<span class="input-group-text">Password:</span> <input
									type="password" name="pass" value="${connectiontoken.pass}"
									class="form-control"
									aria-label="Amount (to the nearest dollar)">
							</div>
							...
							<div class="input-group mb-3">
								<span class="input-group-text">Token:</span> <input type="text"
									name="token" value="${connectiontoken.token}"
									class="form-control"
									aria-label="Amount (to the nearest dollar)">
							</div>
								...
								<select class="form-select" aria-label="Default select example"
									...
									<c:forEach items="${typedbDAO.list()}" var="typedb">
										<option value="${typedb.id}">
											<c:out value="${typedb.description}" />
										</option>
									</c:forEach>
								</select>
							</div>
							...
							<div class="input-group mb-3">
								<select class="form-select" aria-label="Default select example"
									name="usuario">
									<option selected value="${connectiontoken.usuario.getId()}">Usuario:</option>
